...
from webapp.views.baskets import BasketAddFormView, BasketDeleteOneView, BasketDeleteView
...
urlpatterns = [
    ...
    path('basket/products/', OrderCreateView.as_view(), name='basket_list'),
    ...
    path('basket/products/order', OrderCreateView.as_view(), name='order'),
]
